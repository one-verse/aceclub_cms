// components/BrunoGamesWorks.js
export default function BrunoGamesWorks() {
  const features = [
    {
  ...
  return (
    <section className="text-white bg-black bg-neutral-900 py-12">
      ...
      <div className="text-center mb-10">
        <h2 className="text-5xl font-sans">How BrunoGames Works</h2>
        <p className="text-muted mt-4 max-w-3xl mx-auto">
          Discover the key features that make BrunoGames the ultimate platform for
